...
const Nav: React.FC = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      {showBrand ? <div className={styles.brand}>My Brand Name</div> : ""}
      <div className={styles.right}>
        {showSearch && <div className={styles.searchInput}> <input type="text" autoFocus /> </div>}
        <div onClick={() => {showSearchBar()}} className={styles.search}>
